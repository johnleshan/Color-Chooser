...
class Chooser(Dialog):
    """Create a dialog for the tk_chooser command.
    Args:
        master: The master widget for this dialog. If not provided
           defaults to option['parent'] (if defined).
    ...
    def _fixoptions(self):
        ...
        Convert initial color from a RGB triplet to a color string.
        """
    ...
    def _fixresult(self, widget, result):
        ...
        tk color in the string in the form #rrggbb.
        """
        # Result can be many things: an empty tuple, a empty string, or
...
def askcolor(color=None, **options):
    ...
    Conveniece wrapper for the Chooser class. Displays the color
